...
import movieSlice, { initialState } from '../redux/movieSlice'
...
function renderWithProvider(
    ...
    {
        preloadedState = {movie: initialState},
        // Automatically create a store instance if no store was passed in
        store = configureStore({ reducer: { movie: movieSlice }, preloadedState }),
        ...renderOptions
...
const renderObj = { renderWithProvider }
